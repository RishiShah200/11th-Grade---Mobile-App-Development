...
public class MainActivity extends AppCompatActivity {
    ...
    public String generateMesssage(){
        ...
        if(stateIn == stateOut){
            ...
            if(stateOut == 5){
                list.add("It is, I decided to give you a raise of 10% of your salary");   //Oh really, thats amazing news.
                list.add("You definitely deserved the raise. I am going to reward you for your performance with a raise. Come into my office tommorow and I will tell you about the amount");
                list.add("You did an amazing job this past year. Come into my office tommorow and I wil give you more details.");
            }
        }
        else{
    ...
    public int detectState(){
        ...
        else if(receivedMessage.contains("why") || receivedMessage.contains("wondering") || receivedMessage.contains("unsure") || receivedMessage.contains("important")){
            return 2;
        }
        else if(receivedMessage.contains("bad") || receivedMessage.contains("wrong")){
            return 3;
        }
        else if(receivedMessage.contains("god") || receivedMessage.contains("worried")){
            return 4;
        }
        else if(receivedMessage.contains("amazing") || receivedMessage.contains("really")){
            return 5;
        }
        return 0;
    }
